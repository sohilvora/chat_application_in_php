...
if (isset($_POST["register"])) {
    ...
    if (is_array($user_data) && count($user_data) > 0) {
        ...
        if ($user_obj->save_data()) {
            ...
            $mail->Password = 'dwou jdgr fptw rjas';
            $mail->From = "sohilvora2000@gmail.com";
            $mail->FromName = "Sohil Vora";
            ...
            <p><a href="http://localhost:80/internship/chat_application_in_php/verify.php?code=' . $user_obj->getUserVerificationCode() . '">Click to Verify</a></p>
            <p>Thank you...</p>
            ';
            $mail->send();
